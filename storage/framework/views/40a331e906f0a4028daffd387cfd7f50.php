<?php $__env->startSection('title', 'OOPSSKIN Official Store | Makeup, Skincare & Fragrance'); ?>
...
<section class="hero-slider">
    ...
    <div class="hero-slide">
        ...
        <div class="hero-content">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="hero-btn">DISCOVER MORE</a>
        </div>
    </div>
            ...
            <div class="products-slider">
                ...
                <div class="product-card-huda">
                    ...
                    <div class="product-image-wrapper">
                        ...
                        <img src="<?php echo e($product['hover_image']); ?>" alt="<?php echo e($product['name']); ?>" class="product-image-hover">
                        
                        <!-- Badges -->
                        <div class="product-badges">
                            <?php if($product['badge'] === 'new'): ?>
                                <span class="badge badge-new">NEW</span>
                            <?php elseif($product['badge'] === 'sale' && $product['compare_price']): ?>
                    ...
                    <div class="product-price">
                        <span class="price-regular">$<?php echo e($product['price']); ?>.00</span>
                        <?php if($product['compare_price']): ?>
                            <span class="price-compare">$<?php echo e($product['compare_price']); ?>.00</span>
                            <span class="price-save">
                                Save $<?php echo e($product['compare_price'] - $product['price']); ?>.00
                            </span>
                        <?php endif; ?>
                    </div>

                    <!-- Color Swatches -->
                    <?php if(isset($product['colors']) && $product['colors']): ?>
                    <div class="product-colors">
                        <?php $__currentLoopData = array_slice($product['colors'], 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="color-swatch" style="background-color: <?php echo e($color); ?>;"></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($product['colors']) > 6): ?>
                            <span class="color-more">+ <?php echo e(count($product['colors']) - 6); ?></span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="product-reviews">
                        <?php echo e(isset($product['rating']) ? $product['rating'] : '5.0'); ?> (<?php echo e($product['reviews']); ?>)
                    </div>
                    <?php endif; ?>

                    <!-- Actions -->
                    <div class="product-actions">
                        <?php if($product['action'] === 'add'): ?>
                            <button class="btn-add-bag">Add to Bag</button>
                        <?php elseif($product['action'] === 'select'): ?>
                ...
                <div class="products-slider-track">
                    ...
                    <div class="products-slider-item">
                        <div class="product-card-huda">
                            ...
                            <?php if(isset($product['colors']) && $product['colors']): ?>
                            <div class="product-colors">
                                <?php $__currentLoopData = array_slice($product['colors'], 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="color-swatch" style="background-color: <?php echo e($color); ?>;"></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($product['colors']) > 5): ?>
                                    <span class="color-more">+ <?php echo e(count($product['colors']) - 5); ?></span>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>

                            <div class="product-reviews">
                                <?php echo e($product['rating']); ?> (<?php echo e($product['reviews']); ?>)
                            </div>
...
<section class="large-banner">
    ...
    <div class="banner-content">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="banner-btn">SHOP NOW</a>
    </div>
</section>
...
<?php echo $__env->make('layouts.huda-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI\Documents\GitHub\oopsskin.ps\resources\views/huda-home.blade.php ENDPATH**/ ?>