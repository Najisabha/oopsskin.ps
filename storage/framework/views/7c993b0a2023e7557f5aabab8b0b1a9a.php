...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'OOPSSKIN | Official Store'); ?></title>
...
<body>
    ...
    <header class="main-header">
        <div class="container" style="position: relative;">
            <div class="header-top">
                ...
                <div class="header-icons">
                    <a href="<?php echo e(route('cart.index')); ?>" class="header-icon" title="Cart">
                        <i class="bi bi-bag"></i>
                    ...
                    <a href="<?php echo e(route('settings')); ?>" class="header-icon" title="Account">
                        <i class="bi bi-person"></i>
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="header-icon" title="Log in">
                        <i class="bi bi-person"></i>
                    </a>
                    <?php endif; ?>

                    <a href="<?php echo e(route('search')); ?>" class="header-icon" title="Search">
                ...
                <!-- Logo Center -->
                <div class="logo">
                    <a href="<?php echo e(route('home')); ?>">oopsskin</a>
                </div>
        ...
        <nav class="main-nav">
            <div class="container">
                <ul id="nav-pills">
                    <li><a href="<?php echo e(route('home')); ?>" data-ar="الرئيسية" data-en="Home">الرئيسية</a></li>
                    <li><a href="#" data-ar="الأكثر مبيعاً" data-en="Best Sellers">الأكثر مبيعاً</a></li>
                    <li><a href="#" data-ar="جديد" data-en="New">جديد</a></li>
                    <li><a href="<?php echo e(route('categories.index')); ?>" data-ar="ميكاب" data-en="Makeup">ميكاب</a></li>
                    ...
                    <li class="mega-menu-wrapper">
                        <a href="<?php echo e(route('products.index')); ?>" data-ar="جميع المنتجات" data-en="All Products">جميع المنتجات</a>
                        ...
                        <div class="mega-menu">
                            <div class="mega-menu-inner">
                                ...
                                <div class="mega-menu-footer">
                                    <a href="<?php echo e(route('products.index')); ?>" class="mega-menu-btn" data-ar="تسوق جميع المنتجات" data-en="SHOP ALL PRODUCTS">تسوق جميع المنتجات</a>
                                </div>
                            </div>
                        </div>
                    </li>
        ...
        <div class="mobile-menu-content">
            ...
            <div class="mobile-menu-section">
                <ul>
                    ...
                    <li><a href="#" data-ar="🎁 باكيجات" data-en="🎁 Packages">🎁 باكيجات</a></li>
                    <li><a href="#" data-ar="🧴 سكين كير" data-en="🧴 Skincare">🧴 سكين كير</a></li>
                    <li><a href="<?php echo e(route('products.index')); ?>" data-ar="🛍️ جميع المنتجات" data-en="🛍️ All Products">🛍️ جميع المنتجات</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> OOPSSKIN. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\MSI\Documents\GitHub\oopsskin.ps\resources\views/layouts/huda-app.blade.php ENDPATH**/ ?>