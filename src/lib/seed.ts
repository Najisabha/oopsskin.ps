...
export const seedProducts: Product[] = samples.map(([id, name, nameAr, description, descriptionAr, price, compareAtPrice, category, image, stock, badge]) => ({ id, name, nameAr, description, descriptionAr, price, compareAtPrice, category, images: [`/images/${image}.jpg`], stock, badge, active: true, externalId: null, externalSource: null, syncedAt: null, createdAt: "2026-09-01T00:00:00.000Z" }));
